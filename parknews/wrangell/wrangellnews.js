$.getJSON("https://developer.nps.gov/api/v1/newsreleases?parkCode=wrst&stateCode=ak&limit=10&start=0&api_key=SJ788heSyZSEEK0QdQNGXsKAcq7fLZxDxl4keeYw", 
    function(info) {
     console.log(info);
