$.getJSON("https://developer.nps.gov/api/v1/events?parkCode=yose&limit=10&start=0&fields=&api_key=SJ788heSyZSEEK0QdQNGXsKAcq7fLZxDxl4keeYw", 
    function(info) {
     console.log(info);
     ...
     var eventfeeinfo3= info.data[2].feeinfo
     ...
     var eventfeeinfo4= info.data[3].feeinfo
     var eventcontactname4= "Contact Name: " + info.data[3].contactname
     var eventcontactemail4= "Contact Email: " + info.data[3].contactemailaddress
     var eventphonenumber4= "Contact Telephone Number: " + info.data[3].contacttelephonenumber
     ...
     var eventfeeinfo5= info.data[4].feeinfo
     ...
     var eventfeeinfo6= info.data[5].feeinfo
     ...
     var eventfeeinfo7= info.data[6].feeinfo
     ...
     var eventfeeinfo8= info.data[7].feeinfo
     ...
     var eventfeeinfo9= info.data[8].feeinfo
     ...
     var eventfeeinfo10= info.data[9].feeinfo
     ...
     $('.eventfeeinfo3').append(eventfeeinfo3);
     ...
     $('.eventfeeinfo4').append(eventfeeinfo4);
     $('.eventcontactname4').append(eventcontactname4);
     $('.eventcontactemail4').append(eventcontactemail4);
     $('.eventphonenumber4').append(eventphonenumber4);

     $('.eventtitle5').append(eventtitle5);
     $('.eventdescription5').append(eventdescription5);
     $('.eventdates5').append(eventdates5);
     $('.eventfeeinfo5').append(eventfeeinfo5);
     ...
     $('.eventfeeinfo6').append(eventfeeinfo6);
     ...
     $('.eventfeeinfo7').append(eventfeeinfo7);
     ...
     $('.eventfeeinfo8').append(eventfeeinfo8);
     ...
     $('.eventfeeinfo9').append(eventfeeinfo9);
     ...
     $('.eventfeeinfo10').append(eventfeeinfo10);
